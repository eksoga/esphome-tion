...
[esphome-release-shield]: https://img.shields.io/static/v1?label=ESPHome&message=2025.6.0&color=green&logo=esphome
...
> [!IMPORTANT]
> Для сборки используется рекомендованная ESPHome версия esp-idf, если возникают проблемы с соединением используйте пакет esp-idf/4.4.7.yaml.
